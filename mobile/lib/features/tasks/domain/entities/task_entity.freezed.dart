...
class _$TaskEntityImpl implements _TaskEntity {
  ...
  @override
  String toString() {
    return 'TaskEntity(id: $id, title: $title, description: $description, type: $type, points: $points, isCompleted: $isCompleted, completedAt: $completedAt, planId: $planId)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, title, description, type,
      points, isCompleted, completedAt, planId);
...
abstract class _TaskEntity implements TaskEntity {
  const factory _TaskEntity(
      ...
      final DateTime? completedAt,
      final String? planId}) = _$TaskEntityImpl;
